...
const emit = defineEmits(['dish-removed', 'dish-added', 'dish-removed-completely'])
</script>

<template>
    <div class="flex justify-between px-8 py-8 bg-white w-full h-fit rounded-2xl shadow-md gap-4 overflow-hidden">
            ...
            <div class="flex flex-col w-full">
                ...
                <span class="py-4 text-gray-500">{{ dish.nutrition.calories }} x {{ dishCount }} = {{ totalCalories }} ккал</span>
            </div>
        <div class="flex flex-col justify-between items-end">
            <button @click="emit('dish-removed-completely')"><img   :src="trashIcon" class="size-8"/></button>
